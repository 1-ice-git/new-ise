...
{
    public class ValutaUfficioModel
    {
        [Key]
        [Display(Name = "ID")]
        ...
        [Required(ErrorMessage = "La valuta è richiest.")]
        [Display(Name = "Valuta")]
        ...
        [CustomValidation(typeof(dtParValutaUfficio), "VerificaDataInizio")]
        ...
        public ValuteModel Valuta { get; set; }
