...
namespace NewISE.Areas.Parametri.Models.dtObj
{
    public class dtPercMaggAbitazione : IDisposable
    {
        ...
        public IList<PercMaggAbitazModel> getListMaggiorazioneAbitazione(decimal idLivello, decimal idUfficio)
        {
            List<PercMaggAbitazModel> libm = new List<PercMaggAbitazModel>();
        ...
        public bool CoefficienteFasciaKmAnnullato(PercMaggAbitazModel ibm)
        {
            using (ModelDBISE db = new ModelDBISE())
            {
                return db.PERCENTUALEMAB.Find(ibm.idPercMabAbitaz).ANNULLATO == true ? true : false;
            }
        }
        ...
        public static ValidationResult VerificaDataInizio(string v, ValidationContext context)
        {
            ...
            if (fm != null)
            {
                DateTime d = DataInizioMinimaNonAnnullataMaggAbitazione(fm.idLivello,fm.idUfficio);
